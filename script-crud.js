...
function criarElementoTarefa(tarefa) {
    ...
    botao.onclick = () => {
        /* debugger para debugar o código passo a passo */
    ...
    btnDeletar.addEventListener('click', limpaFormulario);
...
const removerTarefas = (somenteCompletas) => {
    ...
    */
    ...
    tarefas = somenteCompletas ? tarefas = tarefas.filter(e => !e.completa) : []
    atualizarTarefa()
}
